(custom-set-variables
 ...
 '(erc-autoaway-mode t)
 '(erc-autojoin-channels-alist (quote (("freenode.net" "#boxgrinder" "#deltacloud" "#torquebox" "#steamcannon") ("redhat.com" "#oddteam" "#projectodd" "#cloude"))))
 '(erc-away-nickname "tcrawley_away")
 ...
 '(erc-pals (quote ("bobmcw" "mgoldmann" "bbrowning" "jc3" "lanceball")))
 '(erc-public-away-p t)
 '(erc-system-name nil)
 '(show-paren-mode t)
...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(linum ((t (:inherit (shadow default) :background "grey15" :foreground "grey40")))))
